    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php">Cães</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="index.php">Gatos</a>
                </li>
                <li class="nav-item">
                ...
                <?php if (isset($_SESSION['tipo_usuario']) && $_SESSION['tipo_usuario'] == 'cliente'): ?>
                    <!-- Abas visíveis apenas para clientes -->
                    <li class="nav-item">
                        <a class="nav-link" href="meus_agendamentos.php">Meus Agendamentos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="minhas_compras.php">Minhas Compras</a>
                    </li>
                <?php elseif (isset($_SESSION['tipo_usuario']) && $_SESSION['tipo_usuario'] == 'funcionario'): ?>
                    <!-- Abas visíveis apenas para funcionários -->
                    <li class="nav-item">
                        <a class="nav-link" href="gerenciar_servicos.php">Gerenciar Serviços</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="gerenciar_produtos.php">Gerenciar Produtos</a>
                    </li>
                <?php endif; ?>
                <!-- Botão de Login adicionado ao menu em telas pequenas -->
                <li class="nav-item d-lg-none">
                    <a href="FormLogin.php" class="btn btn-outline-primary login-btn">Login</a>
                </li>
            </ul>
        </div>
