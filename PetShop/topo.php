    ...
    <link rel="stylesheet" href="estilo.css">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#">Cães</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Gatos</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Produtos</a></li>
                    <li class="nav-item"><a class="nav-link" href="servicos.php">Serviços</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Agendar Horário</a></li>
                    
                    <?php if (isset($_SESSION['usuario_tipo'])): ?>
                        <?php if ($_SESSION['usuario_tipo'] === 'cliente'): ?>
                            <li class="nav-item"><a class="nav-link" href="ver_agendamentos.php">Ver Agendamentos</a></li>
                        <?php elseif ($_SESSION['usuario_tipo'] === 'funcionario'): ?>
                            <li class="nav-item"><a class="nav-link" href="cadastro_produto.php">Cadastro de Produto</a></li>
                        <?php endif; ?>
                        <!-- Opção de Logout -->
                        <li class="nav-item"><a class="nav-link" href="Classe-Login.php">Logout</a></li>
                    <?php else: ?>
            ...
            <a href="FormLogin.php" class="btn btn-outline-primary login-btn d-none d-lg-block">Login</a>
        </div>
    </nav>
</body>
</html>