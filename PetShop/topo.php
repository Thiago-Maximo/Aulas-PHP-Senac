    ...
    <nav class="navbar navbar-expand" id="navegacao">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <ul class="navbar-nav nav-pills mx-auto">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link" id="caes">Cães</a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link" id="gatos">Gatos</a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link" id="produtos">Produtos</a>
                </li>
                <li class="nav-item">
                    <a href="servicos.php" class="nav-link" id="servicos">Serviços</a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link" id="agendar">Agendar Horario</a>
                </li>
            </ul>

            <!-- Botão de pesquisa e ícone de lupa -->
            <div class="d-flex align-items-center">
                <input type="search" class="form-control form-control-sm" id="Botao-Pesquisa">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16" id="Lupa-Pesquisa">
